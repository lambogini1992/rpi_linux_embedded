#ifndef __GPIO_REGISTER_H__
#define __GPIO_REGISTER_H__

/*Define address base for peripheral hardware*/
#define BCM2835_PERIPHERAL_BASE      0x20000000 //Physical address hardware is mapped on virtual hardware
#define GPIO_BASE_PERIPHERAL         (BCM2835_PERIPHERAL_BASE + 0x200000)   // GPIO address offset
